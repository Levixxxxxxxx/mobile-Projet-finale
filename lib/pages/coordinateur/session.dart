...
class CoordinatorSession extends StatefulWidget {
    final String token;
  const CoordinatorSession({super.key, required this.token});

  @override
  State<CoordinatorSession> createState() => _CoordinatorSessionState();
}

class _CoordinatorSessionState extends State<CoordinatorSession> {
  ...
  Widget build(BuildContext context) {
    ...
    body: isLoading
        ...
        : SingleChildScrollView(
            ...
            child: Column(
              children: [
                Text('Session' , style: TextStyle(color: Colors.white , fontWeight: FontWeight.w800, fontSize: 25),),
                SizedBox(height: 15,),
                Row(
